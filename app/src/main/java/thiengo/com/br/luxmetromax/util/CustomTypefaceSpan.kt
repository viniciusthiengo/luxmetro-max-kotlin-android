package thiengo.com.br.luxmetromax.util
...
class CustomTypefaceSpan(typeFace: Typeface) : TypefaceSpan("") {
    ...
    private fun applyCustomTypeFace(paint: Paint, typeface: Typeface) {
        ...
        /*
         * Verifica se a fonte mais atual já está de acordo com
         * a anterior em termos de "texto em negrito”, caso não,
         * atualiza.
         * */
        ...
        /*
         * Verifica se a fonte mais atual já está de acordo com
         * a anterior em termos de "texto em itálico”, caso não,
         * atualiza.
         * */
